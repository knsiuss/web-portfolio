...
export default function AnimatedSignature() {
    ...
    // Reduced motion: show fully static
    ...
    // Helper to build per-path animate props
    const strokeAnimate = (duration: number, delay: number) => ({
    ...
    const fillAnimate = (delay: number) => ({
        fill: isInView ? "rgba(197,245,66,1)" : "rgba(197,245,66,0)",
        transition: { duration: 0.5, ease: "easeIn" as Easing, delay },
    });
    ...
    return (
        ...
        >
            <g transform="translate(0, 1024) scale(0.1, -0.1)">
                ...
                />
                {/* Main fill floods in after stroke completes */}
                <motion.path
                    d={PATH_MAIN}
