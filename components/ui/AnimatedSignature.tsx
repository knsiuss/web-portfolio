...
export default function AnimatedSignature() {
    ...
    // Animation variants for drawing the path sequentially
    const pathVariants: Variants = {
        hidden: {
            pathLength: 0,
            fill: 'rgba(197, 245, 66, 0)',
            opacity: 0
        },
    ...
    return (
        ...
        >
            <g transform="translate(0, 1024) scale(0.1, -0.1)">
                {/* Main Signature Outline Draw & Fill */}
                <motion.path
                    d={PATH_MAIN}
