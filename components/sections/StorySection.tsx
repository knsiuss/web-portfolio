  ...
  return (
    <section className="relative bg-black py-16 md:py-32 overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        >
          <span className="font-tech text-[10px] md:text-xs uppercase tracking-[0.3em] text-[#DFFF00] mb-2 md:mb-4 block">
            Random Facts
          </span>
          <h2 className="font-lando text-3xl sm:text-5xl md:text-7xl uppercase">
            How I Got <span className="text-transparent" style={{ WebkitTextStroke: '1.5px #DFFF00' }}>Here</span>
          </h2>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8 mb-16 md:mb-24">
          ...
          <motion.div
            ...
            className="group"
          >
            <div className="bg-[#111] border border-white/10 rounded-xl md:rounded-2xl p-6 md:p-8 h-full hover:border-[#DFFF00]/30 transition-all">
              <span className="font-lando text-4xl md:text-6xl text-white/5 group-hover:text-[#DFFF00]/10 transition-colors block mb-2 md:mb-4">
                01
              </span>
              <h3 className="font-lando text-xl md:text-2xl uppercase mb-3 md:mb-4 text-white group-hover:text-[#DFFF00] transition-colors">
                The Iron Man Thing
              </h3>
              <p className="font-tech text-sm md:text-base text-white/60 leading-relaxed">
        ...
        >
          <div className="absolute -top-4 md:-top-8 left-0 md:-left-8">
            <Quote className="w-10 h-10 md:w-16 md:h-16 lg:w-24 lg:h-24 text-[#DFFF00] opacity-20" />
          </div>
          
          <div className="bg-[#111] border border-white/10 rounded-2xl md:rounded-3xl p-6 md:p-8 lg:p-12 text-center">
            <blockquote>
              <p className="font-lando text-xl sm:text-2xl md:text-3xl lg:text-5xl uppercase leading-tight mb-4 md:mb-6">
                <span className="text-white">I'm not perfect, </span>
                <span className="text-white/40">but when I have a goal,</span>
                <br />
                <span className="text-[#DFFF00]">I DON'T STOP UNTIL I GET IT.</span>
              </p>
            </blockquote>
            
            <div className="flex items-center justify-center gap-3 md:gap-4">
              <div className="h-[1px] w-8 md:w-12 bg-[#DFFF00]/50" />
              <span className="font-tech text-[10px] md:text-xs uppercase tracking-[0.15em] md:tracking-[0.2em] text-white/30">
        ...
        >
          {['Always Learning', 'Too Stubborn To Quit', 'F1 > Football'].map((tag) => (
            <span 
              key={tag}
              className="font-tech text-[10px] md:text-xs uppercase px-3 md:px-4 py-1.5 md:py-2 border border-white/10 rounded-full text-white/50"
            >
              {tag}
            </span>
          ))}
